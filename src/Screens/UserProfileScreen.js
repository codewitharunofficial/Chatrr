import { View, Text, TouchableOpacity, StyleSheet, TextInput, ScrollView, ActivityIndicator, BackHandler, Dimensions } from "react-native";
   ...
   loading ? (
    ...
    <>
    {
      ...
      >
        ...
        <MaterialIcons onPress={uploadPhoto} name="photo-camera" size={30} color='gray' 
        style={{position: 'absolute', left:`65%`, top: `45%`, zIndex: 1}} />
      </View>
        </View>
